...
SIMAPP = ./app
HTTPS_GIT := https://github.com/Helios-Chain-Labs/ethermint.git
...
PACKAGE_NAME:=github.com/Helios-Chain-Labs/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/Helios-Chain-Labs/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/Helios-Chain-Labs/ethermint/tests/importer
